...
<body>
	<div>
    	...
    	<tr>
    		<td class="t0">Numero de aluno：</td>
    		<td>
    			<input type="text" placeholder="Introduza o seu numero de aluno" name="naluno" id="naluno" class="t1" required="required">
    			<span style="color: rgba(176,0,0);font-size: 24px;">*</span>
    		</td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td class="t0">curso：</td>
    		<td>
    			<input type="text" placeholder="curso" name="curso" id="curso" class="t1" required="required">
    			<span style="color: rgba(176,0,0);font-size: 24px;">*</span>
    		</td>
    	</tr>
    	<tr>
	...
	<?php 
		...
		if (!$link){
			...
			if(isset($_POST['registar']))
			{
				...
				$result1=mysqli_query($link,"select * from estudante where username='$username'");
				$result2=mysqli_query($link,"select * from estudante where naluno='$naluno'");
				...
				if($password1==$password2)
				{
					...
					else
					{
						...
						{
							echo"<script>alert('Numero de aluno já existe!')</script>";
							exit();
						}
						else
						{
							mysqli_query($link,"insert into estudante values ('$username','$naluno','$nome','$apelido','$sexo' , NULL , NULL, '$curso')");
